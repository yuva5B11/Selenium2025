...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Velocity Automation Report"); // Title of report
		sparkReporter.config().setReportName("Velocity Functional Testing"); // name of the report
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			String imgPath = new TestCaseBase().captureScreen(result.getName());
